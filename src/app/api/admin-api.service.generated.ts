...
export class AdminApiAuthApiClient {
     ...
     * @return Success
     */
    login(body?: LoginRequest | undefined): Observable<AuthenticatedResponse> {
...
export class AdminApiPostApiClient {
     ...
     * @return Success
     */
    getPostById(id: string): Observable<PostDetailResponse> {
        let url_ = this.baseUrl + "/api/admin/post/{id}";
        if (id === undefined || id === null)
            throw new Error("The parameter 'id' must be defined.");
        url_ = url_.replace("{id}", encodeURIComponent("" + id));
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return _observableThrow(e) as any as Observable<PostDetailResponse>;
                }
            } else
                return _observableThrow(response_) as any as Observable<PostDetailResponse>;
        }));
    }

    protected processGetPostById(response: HttpResponseBase): Observable<PostDetailResponse> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = PostDetailResponse.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap((_responseText: string) => {
     ...
     * @return Success
     */
    rejectPost(id: string, body?: ReturnBackRequest | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/admin/post/reject/{id}";
        if (id === undefined || id === null)
            throw new Error("The parameter 'id' must be defined.");
        url_ = url_.replace("{id}", encodeURIComponent("" + id));
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processRejectPost(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processRejectPost(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<void>;
                }
            } else
    ...
    protected processRejectPost(response: HttpResponseBase): Observable<void> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
     ...
     * @return Success
     */
    getRejectReason(id: string): Observable<string> {
        let url_ = this.baseUrl + "/api/admin/post/reject-reason/{id}";
        if (id === undefined || id === null)
            throw new Error("The parameter 'id' must be defined.");
        url_ = url_.replace("{id}", encodeURIComponent("" + id));
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetRejectReason(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetRejectReason(response_ as any);
                } catch (e) {
    ...
    protected processGetRejectReason(response: HttpResponseBase): Observable<string> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
     ...
     * @return Success
     */
    getPostActivityLogs(id: string): Observable<PostActivityLogResponse[]> {
        let url_ = this.baseUrl + "/api/admin/post/post-activity-logs/{id}";
        if (id === undefined || id === null)
            throw new Error("The parameter 'id' must be defined.");
        url_ = url_.replace("{id}", encodeURIComponent("" + id));
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetPostActivityLogs(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetPostActivityLogs(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<PostActivityLogResponse[]>;
                }
            } else
                return _observableThrow(response_) as any as Observable<PostActivityLogResponse[]>;
        }));
    }

    protected processGetPostActivityLogs(response: HttpResponseBase): Observable<PostActivityLogResponse[]> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
        ...
        if (status === 200) {
            ...
            if (Array.isArray(resultData200)) {
                ...
                for (let item of resultData200)
                    result200!.push(PostActivityLogResponse.fromJS(item));
            }
            else {
                result200 = <any>null;
            }
     ...
     * @return Success
     */
    getSeries(postId: string): Observable<SeriesResponse[]> {
        let url_ = this.baseUrl + "/api/admin/post/series/{postId}";
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetSeries(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<SeriesResponse[]>;
                }
            } else
                return _observableThrow(response_) as any as Observable<SeriesResponse[]>;
        }));
    }

    protected processGetSeries(response: HttpResponseBase): Observable<SeriesResponse[]> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
        ...
        if (status === 200) {
            ...
            if (Array.isArray(resultData200)) {
                result200 = [] as any;
                for (let item of resultData200)
                    result200!.push(SeriesResponse.fromJS(item));
            }
            else {
                result200 = <any>null;
            }
     ...
     * @return Success
     */
    getTagsByPostId(postId: string): Observable<string[]> {
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetTagsByPostId(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetTagsByPostId(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<string[]>;
                }
            } else
    ...
    protected processGetTagsByPostId(response: HttpResponseBase): Observable<string[]> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
...
export class AdminApiPostCategoryApiClient {
     ...
     * @return Success
     */
    getPostCategories(): Observable<PostCategoryResponse[]> {
        let url_ = this.baseUrl + "/api/admin/post-category";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return _observableThrow(e) as any as Observable<PostCategoryResponse[]>;
                }
            } else
                return _observableThrow(response_) as any as Observable<PostCategoryResponse[]>;
        }));
    }

    protected processGetPostCategories(response: HttpResponseBase): Observable<PostCategoryResponse[]> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
        ...
        if (status === 200) {
            ...
            if (Array.isArray(resultData200)) {
                result200 = [] as any;
                for (let item of resultData200)
                    result200!.push(PostCategoryResponse.fromJS(item));
            }
            else {
                result200 = <any>null;
            }
     ...
     * @return Success
     */
    updatePostCategory(id: string, body?: CreateUpdatePostCategoryRequest | undefined): Observable<void> {
     ...
     * @return Success
     */
    getPostCategoryById(id: string): Observable<PostCategoryResponse> {
        let url_ = this.baseUrl + "/api/admin/post-category/{id}";
        if (id === undefined || id === null)
            throw new Error("The parameter 'id' must be defined.");
        url_ = url_.replace("{id}", encodeURIComponent("" + id));
    ...
    protected processGetPostCategoryById(response: HttpResponseBase): Observable<PostCategoryResponse> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = PostCategoryResponse.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap((_responseText: string) => {
     ...
     * @return Success
     */
    getPostCategoriesPaging(keyword?: string | null | undefined, pageIndex?: number | undefined, pageSize?: number | undefined): Observable<PostCategoryResponsePagingResponse> {
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return _observableThrow(e) as any as Observable<PostCategoryResponsePagingResponse>;
                }
            } else
                return _observableThrow(response_) as any as Observable<PostCategoryResponsePagingResponse>;
        }));
    }

    protected processGetPostCategoriesPaging(response: HttpResponseBase): Observable<PostCategoryResponsePagingResponse> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = PostCategoryResponsePagingResponse.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap((_responseText: string) => {
...
export class AdminApiRoleApiClient {
    ...
    protected processGetRoleById(response: HttpResponseBase): Observable<RoleResponse> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
     ...
     * @return Success
     */
    getRolesPaging(keyword?: string | null | undefined, pageIndex?: number | undefined, pageSize?: number | undefined): Observable<RoleResponsePagingResponse> {
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return _observableThrow(e) as any as Observable<RoleResponsePagingResponse>;
                }
            } else
                return _observableThrow(response_) as any as Observable<RoleResponsePagingResponse>;
        }));
    }

    protected processGetRolesPaging(response: HttpResponseBase): Observable<RoleResponsePagingResponse> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = RoleResponsePagingResponse.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap((_responseText: string) => {
    ...
    protected processGetAllRoles(response: HttpResponseBase): Observable<RoleResponse[]> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
        ...
        if (status === 200) {
            ...
            if (Array.isArray(resultData200)) {
                result200 = [] as any;
                for (let item of resultData200)
                    result200!.push(RoleResponse.fromJS(item));
            }
            else {
                result200 = <any>null;
            }
     ...
     * @return Success
     */
    getAllRolePermissions(roleId: string | null): Observable<PermissionModel> {
    ...
    protected processGetAllRolePermissions(response: HttpResponseBase): Observable<PermissionModel> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = PermissionModel.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap((_responseText: string) => {
     ...
     * @return Success
     */
    savePermission(body?: PermissionModel | undefined): Observable<void> {
...
export class AdminApiSeriesApiClient {
    ...
    protected processGetAllSeries(response: HttpResponseBase): Observable<SeriesResponse[]> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
     ...
     * @return Success
     */
    getSeriesById(id: string): Observable<SeriesDetailResponse> {
        let url_ = this.baseUrl + "/api/admin/series/{id}";
        if (id === undefined || id === null)
            throw new Error("The parameter 'id' must be defined.");
        url_ = url_.replace("{id}", encodeURIComponent("" + id));
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return _observableThrow(e) as any as Observable<SeriesDetailResponse>;
                }
            } else
                return _observableThrow(response_) as any as Observable<SeriesDetailResponse>;
        }));
    }

    protected processGetSeriesById(response: HttpResponseBase): Observable<SeriesDetailResponse> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = SeriesDetailResponse.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap((_responseText: string) => {
     ...
     * @return Success
     */
    getSeriesPaging(keyword?: string | null | undefined, pageIndex?: number | undefined, pageSize?: number | undefined): Observable<SeriesResponsePagingResponse> {
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return _observableThrow(e) as any as Observable<SeriesResponsePagingResponse>;
                }
            } else
                return _observableThrow(response_) as any as Observable<SeriesResponsePagingResponse>;
        }));
    }

    protected processGetSeriesPaging(response: HttpResponseBase): Observable<SeriesResponsePagingResponse> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = SeriesResponsePagingResponse.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap((_responseText: string) => {
     ...
     * @return Success
     */
    getPostsInSeries(seriesId: string): Observable<PostResponse[]> {
    ...
    protected processGetPostsInSeries(response: HttpResponseBase): Observable<PostResponse[]> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
...
export class AdminApiUserApiClient {
    ...
    protected processGetUserById(response: HttpResponseBase): Observable<UserResponse> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
     ...
     * @return Success
     */
    getUsersPaging(keyword?: string | null | undefined, pageIndex?: number | undefined, pageSize?: number | undefined): Observable<UserResponsePagingResponse> {
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return _observableThrow(e) as any as Observable<UserResponsePagingResponse>;
                }
            } else
                return _observableThrow(response_) as any as Observable<UserResponsePagingResponse>;
        }));
    }

    protected processGetUsersPaging(response: HttpResponseBase): Observable<UserResponsePagingResponse> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = UserResponsePagingResponse.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap((_responseText: string) => {
    ...
    changePassword(body?: ChangePasswordRequest | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/admin/user/change-password";
        url_ = url_.replace(/[?&]$/, "");
...
export class PostActivityLogResponse implements IPostActivityLogResponse {
    ...
    constructor(data?: IPostActivityLogResponse) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): PostActivityLogResponse {
        data = typeof data === 'object' ? data : {};
        let result = new PostActivityLogResponse();
        result.init(data);
        return result;
    }
...
export interface IPostActivityLogResponse {
    fromStatus?: PostStatus;
    toStatus?: PostStatus;
    dateCreated?: Date;
    note?: string | undefined;
...
export class PostCategoryResponse implements IPostCategoryResponse {
    id?: string;
    name?: string | undefined;
    slug?: string | undefined;
    parentId?: string | undefined;
    ...
    constructor(data?: IPostCategoryResponse) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): PostCategoryResponse {
        data = typeof data === 'object' ? data : {};
        let result = new PostCategoryResponse();
        result.init(data);
        return result;
    }
...
export class PostCategoryResponsePagingResponse implements IPostCategoryResponsePagingResponse {
    currentPage?: number;
    pageCount?: number;
    pageSize?: number;
    rowCount?: number;
    ...
    results?: PostCategoryResponse[] | undefined;

    constructor(data?: IPostCategoryResponsePagingResponse) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
        ...
        if (_data) {
            ...
            if (Array.isArray(_data["results"])) {
                ...
                for (let item of _data["results"])
                    this.results!.push(PostCategoryResponse.fromJS(item));
            }
        }
    }

    static fromJS(data: any): PostCategoryResponsePagingResponse {
        data = typeof data === 'object' ? data : {};
        let result = new PostCategoryResponsePagingResponse();
        result.init(data);
        return result;
    }
...
export interface IPostCategoryResponsePagingResponse {
    currentPage?: number;
    pageCount?: number;
    pageSize?: number;
    rowCount?: number;
...
export class PostDetailResponse implements IPostDetailResponse {
    id?: string;
    name?: string | undefined;
    slug?: string | undefined;
    description?: string | undefined;
    ...
    static fromJS(data: any): PostDetailResponse {
        data = typeof data === 'object' ? data : {};
        let result = new PostDetailResponse();
        result.init(data);
        return result;
    }
...
export class RoleResponsePagingResponse implements IRoleResponsePagingResponse {
    currentPage?: number;
    pageCount?: number;
    pageSize?: number;
    rowCount?: number;
    ...
    constructor(data?: IRoleResponsePagingResponse) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(_data?: any) {
        if (_data) {
            ...
            if (Array.isArray(_data["results"])) {
                this.results = [] as any;
                for (let item of _data["results"])
                    this.results!.push(RoleResponse.fromJS(item));
            }
        }
    }

    static fromJS(data: any): RoleResponsePagingResponse {
        data = typeof data === 'object' ? data : {};
        let result = new RoleResponsePagingResponse();
        result.init(data);
        return result;
    }
...
export interface IRoleResponsePagingResponse {
    currentPage?: number;
    pageCount?: number;
    pageSize?: number;
    rowCount?: number;
...
export class SeriesDetailResponse implements ISeriesDetailResponse {
    ...
    constructor(data?: ISeriesDetailResponse) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): SeriesDetailResponse {
        data = typeof data === 'object' ? data : {};
        let result = new SeriesDetailResponse();
        result.init(data);
        return result;
    }
...
export interface ISeriesDetailResponse {
    id?: string;
    name?: string | undefined;
    description?: string | undefined;
    slug?: string | undefined;
...
export class SeriesResponse implements ISeriesResponse {
    id?: string;
    name?: string | undefined;
    description?: string | undefined;
    slug?: string | undefined;
    ...
    constructor(data?: ISeriesResponse) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): SeriesResponse {
        data = typeof data === 'object' ? data : {};
        let result = new SeriesResponse();
        result.init(data);
        return result;
    }
...
export class SeriesResponsePagingResponse implements ISeriesResponsePagingResponse {
    currentPage?: number;
    pageCount?: number;
    pageSize?: number;
    rowCount?: number;
    ...
    readonly lastRowOnPage?: number;
    additionalData?: string | undefined;
    results?: SeriesResponse[] | undefined;

    constructor(data?: ISeriesResponsePagingResponse) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(_data?: any) {
        if (_data) {
            ...
            if (Array.isArray(_data["results"])) {
                this.results = [] as any;
                for (let item of _data["results"])
                    this.results!.push(SeriesResponse.fromJS(item));
            }
        }
    }

    static fromJS(data: any): SeriesResponsePagingResponse {
        data = typeof data === 'object' ? data : {};
        let result = new SeriesResponsePagingResponse();
        result.init(data);
        return result;
    }
...
export interface ISeriesResponsePagingResponse {
    currentPage?: number;
    pageCount?: number;
    pageSize?: number;
    rowCount?: number;
...
export class UserResponsePagingResponse implements IUserResponsePagingResponse {
    ...
    readonly lastRowOnPage?: number;
    additionalData?: string | undefined;
    results?: UserResponse[] | undefined;

    constructor(data?: IUserResponsePagingResponse) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(_data?: any) {
        if (_data) {
            ...
            if (Array.isArray(_data["results"])) {
                this.results = [] as any;
                for (let item of _data["results"])
                    this.results!.push(UserResponse.fromJS(item));
            }
        }
    }

    static fromJS(data: any): UserResponsePagingResponse {
        data = typeof data === 'object' ? data : {};
        let result = new UserResponsePagingResponse();
        result.init(data);
        return result;
    }
...
export interface IUserResponsePagingResponse {
    currentPage?: number;
    pageCount?: number;
    pageSize?: number;
    rowCount?: number;
